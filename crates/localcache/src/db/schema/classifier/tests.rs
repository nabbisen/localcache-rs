//! Tests for [`super`]'s schema classification (RFC 010).
//!
//! Relocated from an inline `mod tests` (RFC 015 R6) to satisfy the
//! project's test-placement rule; no test changed behavior.
